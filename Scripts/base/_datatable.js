    ...
    */
    ...
    init: function (selector, url, inputConfig, findJson, fnSuccess, toolbar) {
        ...
        var config = {
            ...
            //多國語
            language: {
                url: "../Scripts/locale/" + _fun.localeCode + "/dataTables.txt",
            },
                ...
                if (filter.length > 0) {
                    ...
                    filter.bind('keyup', function (e) {
                        if (e.keyCode == 13) {
                            ...
                            //run search
                            api.search(this.value).draw();     //必須加上 draw()才會執行查詢 !!
                        }
                    });
                } else {
